...
<h1 style="margin: auto; width: 50%; text-align: center;">Invoice</h1>
...
<div class="row">
		...
		<div class="col-xs-4"><h1>Shipping Address:</h1></div>
		<div class="col-xs-2"><h1>{{data[0].shipaddr}}</h1></div>
		<div class="col-xs-4"><h1>Billing Address:</h1></div>
		<div class="col-xs-2"><h1>{{data[0].billaddr}}</h1></div>
	</div>
...
<!-- <h1 style="margin: auto; width: 50%; text-align: center;">Total:</h1>
<h1 style="margin: auto; width: 50%; text-align: center;">{{total}}</h1> -->
