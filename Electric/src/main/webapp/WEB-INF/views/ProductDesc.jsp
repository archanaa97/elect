...
<body>
<h3 align="center">PRODUCT DESCRIPTION</h3><br/>
 
    <table border="0" class=".table " align="center" >
            
            <tr >
                <td  colspan="3" >Product Id:${proddesc.id}</td>
            </tr>
            <tr> 
              <td rowspan="6" colspan="2" ><img src='${proddesc.imageUrl}' /></td></tr>
              <tr>   <td><b>${proddesc.name}</b></td></tr>
              <%-- <tr>    <td>Brand :${desc.brand}</td></tr> --%>
               <tr>   <td>${proddesc.desc}</td></tr>
               <tr>   <td><b>&#8377;${proddesc.price} </b> </td></tr>
               <tr>   <td>${proddesc.quantity} are left in stock</td></tr>
